...
def build_colab_train_notebook(commit_sha: str) -> dict:
    ...
    cell_1 = {
        ...
        "source": [
            ...
            "    _ud = None\n",
            "if _ud is not None:\n",
            "    for _k in [\"HF_TOKEN\", \"HF_TOKEN_WRITE\", \"HF_TOKEN_READ\", \"KAGGLE_API_TOKEN\", \"KAGGLE_KEY\", \"KAGGLE_USERNAME\", \"HF_REPO_ID\", \"LEGALIR_COMMIT_SHA\"]:\n",
            "        try:\n",
            "            _v = _ud(_k)\n",
            "        except Exception:\n",
            "            _v = None\n",
    ...
    cell_2 = {
        ...
        "source": [
            ...
            "EXPECTED_COMMIT = launch.get(\"expected_sha\") or os.environ.get(\"LEGALIR_COMMIT_SHA\") or APPROVED_COMMIT\n",
